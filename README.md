...
Dự án bao gồm 12 phân hệ chính được thiết kế liên kết chặt chẽ với nhau, giao diện đồng bộ hỗ trợ toàn diện **Dark Mode / Light Mode**:
...
### 9. Tính Tiền Chế Độ Thai Sản (`/thaisan/`)
- Hỗ trợ tính tiền chế độ thai sản cho 7 trường hợp khác nhau (lao động nữ sinh con, nam có vợ sinh con, khám thai, sẩy thai, nhận con nuôi, dưỡng sức sau thai sản, thực hiện biện pháp tránh thai).
- Bảng tóm tắt kết quả cùng với bảng diễn giải chi tiết công thức tính.
- Cập nhật tự động phần căn cứ pháp lý và quy định về điều kiện, thời gian, thủ tục hưởng riêng biệt cho từng chế độ.

### 10. Tính Lãi Vay (`/laivay/`)
- Tính toán tự động số tiền trả hàng tháng theo dư nợ giảm dần hoặc lãi phẳng.
- Hỗ trợ nhập và so sánh đa khoản vay cùng lúc.
- Tư vấn lãi suất dựa trên thị trường thực tế và cung cấp các gói vay tham khảo.
- Trực quan hoá dữ liệu dòng tiền qua biểu đồ và cho phép tải báo cáo chi tiết Excel.

### 11. Đánh Giá Khả Năng Vay (`/khanangvay/`)
- Tính toán hạn mức vay an toàn tối đa dựa trên thu nhập và các khoản nợ hiện tại.
- Phân tích chỉ số DTI (Debt-to-Income) và đưa ra đánh giá rủi ro trực quan.
- Tùy chỉnh tỷ lệ nợ an toàn bằng thanh trượt trực quan.

### 12. Tính Tiền Gửi Tiết Kiệm (`/tietkiem/`)
- Tính lãi suất tiền gửi có kỳ hạn hoặc tích lũy định kỳ.
- Phân tích dòng tiền tương lai với biểu đồ tăng trưởng và cơ cấu vốn - lãi.
- Hỗ trợ tính toán lãi suất linh hoạt và hiển thị bảng lịch sử dòng tiền rõ ràng.
...
├── thaisan/             # Phân hệ 9: Tính Tiền Chế Độ Thai Sản
└── laivay/              # Phân hệ 10: Tính Lãi Vay
├── khanangvay/          # Phân hệ 11: Đánh Giá Khả Năng Vay
└── tietkiem/            # Phân hệ 12: Tính Tiền Gửi Tiết Kiệm
```
